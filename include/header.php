        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                    ...
                    <li><a href="../gpanel"><i class="fa fa-gamepad" aria-hidden="true"></i><?php tl($lang["navbar"]["Panel"]); ?></a></li>
                    <!-- Nie mam na to czasu
                    <li class="dropdown">
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
							...
							<li><a href="?lang=ba"><i class="famfamfam-flags ba" aria-hidden="true"></i> Bosanski</a></li>
							<li><a href="?lang=sr"><i class="famfamfam-flags rs" aria-hidden="true"></i> Srpski</a></li>
							<li><a href="?lang=hr"><i class="famfamfam-flags hr" aria-hidden="true"></i> Hrvatski</a></li>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-3 col-md-push-9">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading"><i class="fa fa-money" aria-hidden="true"></i> <?php echo $config['contact']['title']; ?></div>
                    <div class="panel-body">
