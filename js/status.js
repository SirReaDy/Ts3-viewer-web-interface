        ...
        success: function (json) {
            ...
            if (json.success) {
                ...
                result =
                    ...
                    '<p><i class="fa fa-bolt" aria-hidden="true"></i> ' + statusAvgpl + ': <span class="label label-success">' + averagePacketloss + '%</span></p>'+'<br>'+
					'<p><a href="ts3server://capitains.com" ><img src="../img/connect.png" style="background-size:47px 217px;" /></a></p>';
            } else {
